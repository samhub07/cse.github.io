...
<li>
    ...
    <div class="sticky-header header-section ">
	  ...
	  <div class="forms">
          <h3 class="title1">Class Information</h3>
          ...
          <div class="form-title">
              <h4>Basic Form :</h4>
                ...
                <div class="form-group"> 
                  ...
                  <input type="varchar" class="form-control" id="sub_name" name="subject_name"> </div> 
                <div class="form-group"> 
                  <label for="exampleInputPassword1">Class Teacher name</label> 
                <input type="varchar" class="form-control" id="st" name="t_fullname">
                 </div> 
                <div class="form-group"> 
                  <label for="exampleInputFile">Total Students</label>
                  <input type="varchar" class="form-control" id="c" name="st">
	...
	if(isset($_POST['sub']))
	{
	 ...
	 $st = $_POST['st'];
				{
			$query="INSERT INTO `subjects_info`(`subject_name`, `t_fullname`, `st`) VALUES ('$subject_name','$t_fullname','$st')";
...
?>
 ...
 <section id="section-4">
	...
	<tr>
												...
												<?php $sub_dis_admin = $ravi->subject_info();
													$t_sn = 1;
													while($sub_info_admin =$sub_dis_admin->fetch_assoc())					{
																		...
																		<tr>
																			...
																			<td><?php echo $sub_info_admin['subject_name']; ?></td>
																			<td><?php echo $sub_info_admin['t_fullname']; ?></td>
																			<td><?php echo $sub_info_admin['st']; ?></td>
