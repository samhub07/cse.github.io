...
if(isset($_POST['up_teacher']))
{
	...
	$update_done = $ravi->update_teacher_info($up_fullname,$up_address,$up_father,$up_mother,$up_dob,$up_contact,$up_gender,$teacher_id);
	if($update_done==true)
	{
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">Full Name</label>
						<div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" name="up_fullname" value="		<?php echo ucfirst($student_name_display['st_fullname']); ?>
											"> </div>
					</div>
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">Address</label>
						<div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" name="up_address" value="		<?php echo ucfirst($student_name_display['st_address']); ?>
											"> </div>
					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Father</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_father" value="	<?php echo ucfirst($student_name_display['st_father']); ?>
												"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Mother</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_mother" value="	<?php echo ucfirst($student_name_display['st_mother']); ?>
												"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">DOB</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_dob" value="	<?php echo ucfirst($student_name_display['st_dob']); ?>
												"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Contact</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="up_contact" value="		<?php echo ucfirst($student_name_display['st_parents_contact']); ?>
											"> </div>
					...
					<div class="form-group">
						...
						<select id="selector1" class="form-control1" name="up_gender">
						   <option value="	<?php echo ucfirst($student_name_display['st_gender']); ?>
