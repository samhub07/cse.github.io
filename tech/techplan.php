...
<div id="page-wrapper">
      <div class="main-page">
        <div class="forms">
          <h3 class="title1">Subjects Information</h3>
          <div class="form-grids row widget-shadow" data-example-id="basic-forms">
          <div class="form-title">
              <h4>Basic Form :</h4>
            </div>
            <div class="form-body">
                  <form action="techplan.php" method="post" enctype="multipart/form-data">
                <div class="form-group"> 
                  <label for="exampleInputEmail1">Subject name</label> 
                  <input type="varchar" class="form-control" id="sub_name" name="sub_name"> </div> 
                <div class="form-group"> 
                  <label for="exampleInputPassword1">Class name</label> 
                <input type="varchar" class="form-control" id="st" name="c">
                 </div> 
                <div class="form-group"> 
                  <label for="exampleInputFile">Topic Covered</label>
                  <input type="varchar" class="form-control" id="c" name="tc">
				  </div>
				  <div class="form-group"> 
                  <label for="exampleInputEmail1">Teching Method</label> 
                  <input type="varchar" class="form-control" id="sub_name" name="tm"> </div> 
                <div class="form-group"> 
                  <label for="exampleInputEmail1">Date</label> 
                  <input type="varchar" class="form-control" id="sub_name" name="date"> </div> 
                
                        <button class="btn btn-action" type="submit" name="sub">Save</button>
	...
	if(isset($_POST['sub']))
	{
	 ...
	 $tc = $_POST['tc'];
	 	  $tm = $_POST['tm'];
		  	  $date = $_POST['date'];
				{
			$query="INSERT INTO `techplan`(`sub_name`, `c`, `tc`, `tm`, `date`) VALUES ('$sub_name','$c','$tc','$tm','$date')";


			if(mysqli_query($conn,$query))
			{
			 echo "<script>window.location = 'techplan.php';</script>";
