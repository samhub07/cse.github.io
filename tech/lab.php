...
<body class="cbp-spmenu-push">
 ...
 <section id="section-4">
	...
	<tr>
																		 ...
																		 <tr>
    <td>1</td>
    <td>Networking & Hardware Lab</td>
    <td>Mr.Shendge Sir.</td>
  </tr>
  <tr>
    <td>2</td>
    <td>Programming Lab</td>
    <td>Mr.Aangadi Sir.</td>
  </tr>
  <tr>
    <td>3</td>
  ...
  <tr>
    <td>4</td>
    <td>Data Base Lab</td>
    <td>Mrs. Deshmukh madam.</td>
  </tr>

																	</thead>
																	<tbody> 
																		
												<?php $lab_dis_admin = $ravi->lab_info();
													$t_sn = 1;
													while($lab_info_admin =$lab_dis_admin->fetch_assoc())					{
																		...
																		<tr>
																			...
																			<td><?php echo $lab_info_admin['lab_name']; ?></td>
																			<td><?php echo $lab_info_admin['t_fullname']; ?></td>
