...
<li>
	...
	<div id="page-wrapper">
      <div class="main-page">
          ...
          <h3 class="title1">parents Info</h3>
	...
	<tr>
												...
												<?php $teacher_dis_admin = $ravi->parent_info_display_admin();
													$t_sn = 1;
													while($parent_info_admin =$teacher_dis_admin->fetch_assoc())					{
																		...
																		<tr>
																			...
																			<td><?php echo $parent_info_admin['p_name']; ?></td>
																			<td><?php echo $parent_info_admin['p_address']; ?></td>
																			<td><?php echo $parent_info_admin['p_email']; ?></td>
																			<td><?php echo $parent_info_admin['p_contact']; ?></td>
