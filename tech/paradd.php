...
<?php 
 ...
 if(isset($_POST['add_par_info']))
 {
	  $add_p_name = $_POST['add_p_name'];
	 $add_p_address = $_POST['add_p_address'];
	 $add_p_email = $_POST['add_p_email'];
	 $add_p_contact = $_POST['add_p_contact'];
	 if($add_p_name=="" OR $add_p_address=="" OR $add_p_email=="" OR $add_p_contact=="" )
	 {
	 ...
	 $add_done = $ravi->add_parent($add_p_name,$add_p_address,$add_p_email,$add_p_contact);
	 if($add_done==true)
	 {
				...
				<div class=" form-grids row form-grids-right">
						<div class="widget-shadow " data-example-id="basic-forms"> 
							<div class="form-title">
								<h4>Add parents form :</h4>
							</div>
							<div class="form-body">
				<form class="form-horizontal" method="post">
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">Full Name</label>
						<div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" name="add_p_name" placeholder="Full Name"> </div>
					</div>
					<div class="form-group"> <label for="inputEmail3" class="col-sm-2 control-label">Address</label>
						<div class="col-sm-9"> <input type="text" class="form-control" id="inputEmail3" name="add_p_address" placeholder="Teacher Current Address"> </div>
					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Email</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="add_p_email" placeholder="Email"> </div>

					</div>
					<div class="form-group"> <label for="address" class="col-sm-2 control-label">Contact</label>
						<div class="col-sm-9"> <input type="text" class="form-control" name="add_p_contact" Placeholder="Contact Number"> </div>
</div>
<div>
					<div class="col-sm-offset-2"> 
						<input type="submit" class="btn btn-default" name="add_par_info" value ="Add parents Info">
						</div>
				</form>
							</div>
						</div>
