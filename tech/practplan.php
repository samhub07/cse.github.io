...
<div id="page-wrapper">
      <div class="main-page">
        <div class="forms">
          ...
          <div class="form-title">
            ...
            <div class="form-body">
                  <form action="practplan.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group"> 
                  <label for="exampleInputFile">Experiement</label>
                  <input type="varchar" class="form-control" id="c" name="e">
				  </div>
                <div class="form-group"> 
	...
	if(isset($_POST['sub']))
	{
	 ...
	 $e = $_POST['e'];
	 	 	  $date = $_POST['date'];
				{
			$query="INSERT INTO `pract_info`(`sub_name`, `c`, `e`, `date`) VALUES ('$sub_name','$c','$e','$date')";


			if(mysqli_query($conn,$query))
			{
			 echo "<script>window.location = 'practplan.php';</script>";
