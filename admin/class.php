...
<div id="page-wrapper">
        ...
        <div class="forms">
          ...
          <div class="form-title">
            ...
            <div class="form-body">
                ...
                <div class="form-group"> 
                  <label for="exampleInputPassword1">Taecher name</label> 
                <input type="varchar" class="form-control" id="st" name="t_fullname">
                 </div> 
                <div class="form-group"> 
                  <label for="exampleInputFile">Email</label>
                  <input type="varchar" class="form-control" id="c" name="t_email">
	...
	if(isset($_POST['sub']))
	{
	 ...
	 $t_email = $_POST['t_email'];
				{
			$query="INSERT INTO `subjects_info`(`subject_name`, `t_fullname`, `t_email`) VALUES ('$subject_name','$t_fullname','$t_email')";
  ...
  <section id="section-4">
      ...
      <div class="main-page">
        ...
        <div class="bs-example widget-shadow" data-example-id="bordered-table"> 
            ...
            <table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Subject Name</th> <th>Teacher Name</th> <th>Email</th> </tr> </thead> <tbody> 
                      ...
                      while($display_subject_admin = $subject_info_admins->fetch_assoc())
                      {
                        ?>          <tr> 
                                      ...
                                      <td><?php echo $display_subject_admin['t_email']; ?></td>
